...
fun Context.showToast(it: com.bytebyte6.base_ui.Message) {
    Toast.makeText(
        this,
        it.get(this),
...
fun Fragment.showToast(it: com.bytebyte6.base_ui.Message) {
    requireContext().showToast(it)
}

fun Activity.showToast(it: com.bytebyte6.base_ui.Message) {
    baseContext.showToast(it)
}

fun Context.showSnack(
    view: View,
    it: com.bytebyte6.base_ui.Message,
